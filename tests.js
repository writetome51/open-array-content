...
var PublicArrayContent_1 = require("./PublicArrayContent");
var content = new PublicArrayContent_1.PublicArrayContent(['the', 'long', 'sentence', 'of', 'words', 'is', 'right', 'here']);
content.length = 2;
...
console.log(content.allPass(function (item) { return typeof item === 'string'; })); // true
console.log(content.anyPass(function (item) { return item.length > 4; })); // false
console.log(content.anyPass(function (item) { return item.length > 3; })); // true
...
console.log(content.indexesThatPass(function (item) {
